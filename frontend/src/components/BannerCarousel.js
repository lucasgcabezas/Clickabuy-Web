...
const BannerCarousel = () => {
    const bannerArray = [
        ...
        {id: 2, imageBanner: "https://webdesing881317710.files.wordpress.com/2021/05/5.png"},
        {id: 3, imageBanner: "https://webdesing881317710.files.wordpress.com/2021/05/3-1.png"},
        {id: 4, imageBanner: "https://webdesing881317710.files.wordpress.com/2021/05/find-it-on.png"},
